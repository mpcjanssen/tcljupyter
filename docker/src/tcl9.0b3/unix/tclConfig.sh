...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/mpcjanssen/Src/tcljupyter/docker/tcl9.0b3/unix -ltcl9.0'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/tcl9/lib -ltcl9.0'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/tcl9/include'
...
# compiled.
TCL_SRC_DIR='/home/mpcjanssen/Src/tcljupyter/docker/tcl9.0b3'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/opt/tcl9/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/mpcjanssen/Src/tcljupyter/docker/tcl9.0b3/unix -ltclstub'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/tcl9/lib -ltclstub'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/mpcjanssen/Src/tcljupyter/docker/tcl9.0b3/unix/libtclstub.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/tcl9/lib/libtclstub.a'
